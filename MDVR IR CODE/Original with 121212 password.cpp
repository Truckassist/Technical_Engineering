...
void loop() {
    for (int i = 0; i < 2; i++) {
        ...
        delay(1000);
        irsend.sendNEC(0x106742BD, 32); // Password Diget 1
        delay(1000);
        irsend.sendNEC(0x1067827D, 32); // Password Diget 2
        delay(1000);
        irsend.sendNEC(0x106742BD, 32); // Password Diget 3
        delay(1000);
        irsend.sendNEC(0x1067827D, 32); // Password Diget 4
        delay(1000);
        irsend.sendNEC(0x106742BD, 32); // Password Diget 5
        delay(1000);
        irsend.sendNEC(0x1067827D, 32); // Password Diget 6
        delay(1000);
